...
library(pacman)
pacman::p_load(readr, dplyr, tidyverse, factoextra, MASS, mgcv, ggplot2, patchwork, ggpubr, MASS, bestNormalize, sf, letsR, terra, randomForest, corrplot, pdp, plotly)
```
#data upload
...
length(unique(df_clean$id))#1,615
...
ggsave("range_size_combined.png", range_size_combined, width = 16, height = 12, dpi = 300, units="in")

ggsave("range_size_investment.png", random_investment, width = 6, height = 4, dpi = 300, units="in")
